...
class TestCreateRequestCredit:
    ...
    def test_request_credit(self, api_manager,create_user_request_credit, account_with_credit_request):
    ...
    def test_board_credit(self, api_manager, create_user_request_credit, credit_test_data):
        response = api_manager.user_steps.negative_credit_request(create_user_request_credit, credit_test_data['credit_request'])
        assert credit_test_data['expected_error'] in response.text